															...
															<div class="element">
																<div class="content">
																	<div class="text">
																		...
																		<p>To use custom homepage, you must first create two <a href="<?php echo home_url();?>/wp-admin/post-new.php?post_type=page">new pages</a>, and assign template "<b>Blog</b>" to one of them and  template "<b>Homepage</b>" to the other. Give each page a title, but avoid adding any text.</p>
